 ...
 *            {String|Object|Buffer|Function} [connection.data] In case of:
...
HTTPClient.prototype.open = function (connection, callback) {
    ...
    if('multipart/form-data' === headers['Content-Type']) {
        ...
        isFunction || (headers['Content-Length'] = isBuffer?
            Buffer.byteLength(data) : (isString? data : (data = querystring.stringify(data))).length);
    }
